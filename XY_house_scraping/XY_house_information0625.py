...
def set_log():
    # 儲存路徑
    log_file_path = 'C:\\python_web_scraping\\XY_house_scraping\\XY_house_Taipei\\XY_house_Taipei_informationtest.log'
...
def XY_url_information(partial_url, all_house_data, index):
    ...
    try:
        ...
        # 將所有房屋資料寫入 JSON 檔案
        json_file_path = 'C:\\python_web_scraping\\XY_house_scraping\\XY_house_Taipei\\XY_house_Taipei_informationtest.json'
...
if __name__ == "__main__":
    ...
    # 檢查路徑、資料夾，若不存在就建立
    log_json_path = 'C:\\python_web_scraping\\XY_house_scraping\\XY_house_Taipei'
    ...
    # 讀取房屋list文件
    house_list_path = 'C:\\python_web_scraping\\XY_house_scraping\\XY_house_Taipei\\XY_house_Taipei_urls.json'
