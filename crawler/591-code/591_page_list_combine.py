...
with open("result-data/newtaipei_591_all_list.json") as f:
    json_str_taipei_1 = f.read()

with open("result-data/taipei_591_all_list.json") as f:
    json_str_taipei_2 = f.read()


newtaipei_taipei_list_1 = json.loads(json_str_taipei_1)
taipei_list_2 = json.loads(json_str_taipei_2)
print(len(newtaipei_taipei_list_1))
print(len(taipei_list_2))
